This is a simple Shiny app, where a user can upload their own data in .csv or .txt formats, and generate a correlation matrix plots that also contains density plots and cofficient of correlation values. 
